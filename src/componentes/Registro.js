...
export function Registro() {
  ...
  return (
    <div className="container-fluid">
      ...
      <h4 className="py-5 text-white text-center">¿Quieres ver Nerdflix ya? Ingresa tu email para crear una cuenta</h4>
      <form
        onSubmit={handleSubmit}
        className="container text-center pt-5 mb-5 py-5 col-5"
      >
        ...
        />
        <label htmlFor="password" class="mt-2  text-white text-start ">
          Password
        </label>
        <input
          type="password"
